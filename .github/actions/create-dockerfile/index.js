...
module.exports = {
  go: __nccwpck_require__(6870),
  node: __nccwpck_require__(2153),
  python: __nccwpck_require__(7911),
  spa: __nccwpck_require__(5063),
}
...
`,
  ...
  defaultValues: {
    ...
    command: () => {
      return fs.existsSync(__nccwpck_require__.ab + "makefile")
        ? "start"
...
const stubs = __nccwpck_require__(7409);
